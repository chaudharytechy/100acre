      ...
      <>
          ...
          <Slider ref={sliderRef} {...settings} className="overflow-hidden">
            {project_floorplan_Image &&
              ...
              project_floorplan_Image.map((item, index) => (
                ...
                >
                  <img
                    className="w-full h-auto lg:h-[350px] sm:h-[150px] md:h-[200px] object-cover rounded-xl"
                    src={item.url}
                    alt="floorPlan"
                  />
                </div>
        ...
        <div className="sm:h-auto lg:h-[600px] xl:h-[540px] w-full sm:w-auto bg-[#012e29]">
          <div className="text-center text-white m-4 md:m-8 lg:m-12 xl:m-20 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl lg:pt-4 mt-4">
            <p className="leading-relaxed">
              EXPERIENCE LUXURY LIVING WITH UNPARALLELED AMENITIES AND
              INDULGENCES
            </p>
          </div>
          ...
          <div className="text-justify text-white m-4 md:m-8 lg:m-12 xl:m-20 text-sm sm:text-base md:text-lg lg:text-xl pt-0 mt-4">
            <p className="leading-relaxed">
              Experience unparalleled convenience and access to the city's
              premier attractions, coupled with a serene oasis in the midst of
              the vibrant metropolis. Indulge in the best of everything at Golf
              Island, where prime location and luxurious amenities combine to
              create the ideal address for discerning individuals and families.
            </p>
          </div>
