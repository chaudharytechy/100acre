  ...
  return (
    ...
    <Nav />
      ...
      <div className="relative w-full " style={{
        backgroundImage: 'url("https://as2.ftcdn.net/v2/jpg/02/61/89/29/1000_F_261892957_6jyBXvEgM79iYr1eEiJKCosnVPJdvHHr.jpg")',
      ...
      <div className="flex items-center pt-2 px-10">
        ...
        <p className='text-gray-500 text-lg px-10 py-2 text-justify'>
      ...
      <div className="flex items-center pt-6 px-10">
        <img
          ...
          className="h-10 w-10 "
        />
        <h3 className="pt-1 text-red-600 md:text-xl  lg:text-2xl xl:text-3xl">Awards and Recognitions</h3>
      </div>
      <div>
        <p className='text-gray-500 text-lg px-10 py-2 text-justify'>Our expert team is working on making secure and smooth all legal and mandatory transactions of our housing and commercial projects to
